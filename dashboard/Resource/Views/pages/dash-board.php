    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3"><?php echo "Welcome " . $_SESSION["firstname"]; ?><?php echo ""?> <?php echo $_SESSION["lastname"]; ?>  </div>
            </a>
            ...
            <form method="post">
                <div class="text-center d-none d-md-inline">
                    <button type="submit" name="log-out" style="background-color: red"
                            onclick="confirm('Are you sure to logout?')">Logout
                    </button>
                </div>
            </form>
                                ...
                                <table border="1px" style="text-align: center">
                                    ...
                                    <?php foreach ($goods as $item): ?>
                                        <tr>
                                            ...
                                            <td><a href="dash-board.php?page=update_goods&id=<?php echo $item['id'] ?>">Update</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($page) {
        case "delete_goods":
            ...
            break;
        case "add_goods":
            include_once "../goods/add_goods.php";
            break;
        case "update_phone":
            $goods = $controller->getGoodsById($_GET['id']);
            include_once "../goods/update_goods.php";
            break;
    }
